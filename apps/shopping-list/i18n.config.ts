    ...
    messages: {
        ...
        ru: {
            app: {
                ...
                description:
                    'Добро пожаловать в наше веб-приложение для составления списков покупок! Здесь вы найдете удобный способ создания списков покупок и управления ими. Создавайте списки для покупок продуктов, планируйте свои кулинарные эксперименты или даже упорядочивайте свои задачи.',
